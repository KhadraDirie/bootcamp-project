 ...
 const handleSubmit = (onClick) =>{
  ...
  return (
    ...
    <form className='form mb-4'>
        <label className='block text-white font-medium mb-2' for="firstName"></label>
        <input 
        type="text"
        name='firstName'
        ...
        <label className='block text-white font-medium mb-2 py-1' for='lastName'></label>
        <input
        type ="text"
        name='lastName'
    ...
    <label className='block text-white font-medium mb-2' for ="email"></label>
    <input 
    className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-black leading-tight focus:outline-none focus:bg-white focus:border-purple-500'
    type='email'
    name='email'
